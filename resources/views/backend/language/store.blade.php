                                    ...
                                    <div class="ibox">
                                        <div class="ibox-content">
                                            <div class="row mb15">
                                                <div class="col-lg-6">
                                                    <div class="form-row">
                                                        <label class="form-label">{{ __('messages.namelg') }}
                                                ...
                                                <div class="col-lg-6" style="margin-bottom: 5px">
                                                    <div class="form-row">
                                                        <label class="form-label">{{ __('messages.canonicalLanguage') }}
                                                            <span class="text-danger">(*)</span></label>
                                                ...
                                                <div class="col-lg-12" style="margin-bottom: 5px">
                                                    <div class="form-row">
                                                        <label class="form-label">{{ __('messages.ImgLanguage') }}
                                                            <span class="text-danger">(*)</span></label>
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="form-row">
                                                        <label class="form-label">{{ __('messages.delg') }}
                                                            <span class="text-danger">(*)</span></label>
