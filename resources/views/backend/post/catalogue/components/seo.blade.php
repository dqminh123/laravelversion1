<div class="ibox">
    ...
    <div class="ibox-content">
        <div class="seo-container">
            ...
            <div class="meta-keyword">Bạn chưa có từ khóa SEO</div>
        </div>
            ...
            <div class="row mb-3">
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <input type="text" name="meta-keyword"
                ...
                <div class="col-lg-12">
                    <div class="form-row">
                        ...
                        <textarea type="text" name="meta-description"
                            value="{{ old('meta-description', $postCatalogue->meta_description ?? '') }}" class="form-control" placeholder=""
                            autocomplete="off">
                        </textarea>
                    </div>
                </div>
