    ...
    <div class="ibox-content">
        <div class="seo-container">
            <div class="meta-title">
                {{old('meta_title')?? 'Bạn chưa có tiều đề SEO'}}
            </div>
            <div class="canonical">{{old('canonical')?? 'http://duong-dan-cua-ban.html'}}</div>
            <div class="meta_description">
                {{old('meta_description')?? 'Bạn chưa có mô tả SEO'}}
            </div>
            <div class="meta_keyword">{{old('meta_keyword')?? 'Bạn chưa có từ khóa SEO'}}</div>
        </div>
