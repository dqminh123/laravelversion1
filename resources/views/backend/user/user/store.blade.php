                ...
                <div class="card-body">
                    ...
                    <form action="{{ $url }}" method="post">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label"> {{ __('messages.nameus') }} <span
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="mb-3">
                                        <label class="form-label"> {{ __('messages.emailus') }} <span
                                                class="text-danger">(*)</span></label>
                        ...
                        <!-- end Thông tin chung -->
                        <hr>
                        <h6 class="card-title" style="font-weight: bolder;color:gold">
                            {{ __('messages.tableHeading2') }}</h6>
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    <label class="form-label">{{ __('messages.pv') }}</label>
                                    <select name="province_id" id="province_id"
                                        class="js-example-basic-single form-select form-control province location"
                                        data-width="100%" data-target ="districts">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3">
                                    ...
                                    <select name="ward_id"
                                        class="js-example-basic-single form-select form-control wards"
                                        data-width="100%">
